 ...
 * @author Costin Leau
 */
public class OsgiBundleXmlWebApplicationContext extends
                OsgiBundleXmlApplicationContext implements
        ...
        public void setServletConfig(ServletConfig servletConfig) {
                ...
                if (servletConfig != null) {
                        ...
                        if (getNamespace() == null) {
                                setNamespace(this.servletConfig.getServletName()
        ...
        protected void postProcessBeanFactory(
                ...
                beanFactory.registerResolvableDependency(ServletContext.class,
                                this.servletContext);
                beanFactory.registerResolvableDependency(ServletConfig.class,
                                this.servletConfig);
                ...
                // System.out.println("BasicAlertServiceTest got a " + foo.getBundleContext());
